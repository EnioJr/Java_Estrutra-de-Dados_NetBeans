 ...
 * @author eniojr
 */
public class ClassAresta extends javax.swing.JFrame {
     ...
     */  
      ...
      Grafo grafo ;
      Frame frame1;
    public ClassAresta(Grafo graf,Pintar pinta ,int I,Frame frame){
       this.pintar =pinta;
       this.grafo=graf;
       this.i=I;
       frame1 = frame;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Digite o Tamanho");
        panel.add(jLabel3);
        ...
        panel.getAccessibleContext().setAccessibleName("Nova Aresta");
         ...
         if(x==y)
           JOptionPane.showMessageDialog(null,"Error.. Debe digitar un nodo diferente a : "+y);
            ...
            JOptionPane.showMessageDialog(null,"Error.. Nodos No validos "); 
             ...
             grafo.setmAdjacencia(x, y, 1);
             grafo.setmAdjacencia(y, x, 1);
             grafo.setmCoeficiente(x, y, ta);
             grafo.setmCoeficiente(y, x, ta);
             n1.setText(null);
             n2.setText(null);
             tm.setText(null);
            Pintar.pintarLinea(ClassPrincipal.jPanel1.getGraphics(),grafo.getCordeX(x), grafo.getCordeY(x), grafo.getCordeX(y), grafo.getCordeY(y), ta);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClassAresta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
