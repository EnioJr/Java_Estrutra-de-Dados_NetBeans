 ...
 * @author eniojr
 */
public class EliminarArestas extends javax.swing.JFrame {
int i;
    /**
...
public void R_repaint(){
        for (int j = 0; j < i; j++) {
            for (int k = 0; k < i; k++) {
                if(arboles.getmAdjacencia(j, k) == 1)
                Pintar.pintarLinea(ClassPrincipal.jPanel1.getGraphics(),arboles.getCordeX(j),arboles.getCordeY(j), arboles.getCordeX(k), arboles.getCordeY(k),arboles.getmCoeficiente(j, k));
            }
        }
        for (int j = 0; j < i; j++) {
            Pintar.pintarCirculo(ClassPrincipal.jPanel1.getGraphics(), arboles.getCordeX(j),arboles.getCordeY(j),String.valueOf(arboles.getNome(j)));
 ...
 Pintar pintar ;
      Grafo arboles ;
      Frame frame;
    public EliminarArestas(Pintar pinta , Grafo arbole ,int ii, Frame fram) {
        initComponents();
        i=ii;
        this.pintar =pinta;
       this.arboles=arbole;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Digite o Nó 1");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(10, 30, 110, 14);

        jLabel2.setText("Digite o Nó 2");
        jPanel1.add(jLabel2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"Error.. Faltan datos : ");
            ...
            JOptionPane.showMessageDialog(null,"Error.. Debe digitar un nodo diferente a : "+y);
                ...
                arboles.setmAdjacencia(x, y, 0);
                arboles.setmAdjacencia(y, x, 0);
                arboles.setmCoeficiente(x, y, 0);
                arboles.setmCoeficiente(y, x, 0);
                n1.setText(null);
                n2.setText(null);
                ClassPrincipal.jPanel1.paint(ClassPrincipal.jPanel1.getGraphics());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarArestas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
